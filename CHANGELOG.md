...
## [0.0.5](https://github.com/OxideAV/oxideav-stl/compare/v0.0.4...v0.0.5) - 2026-07-09

### Other

- use Vec::clear over truncate(0) in a test (clippy 0.1.96)
- add mesh_inertia to the geometry Criterion suite + driver
- cover mesh_inertia + repair_drop_duplicate_facets in the repair target
- mesh_inertia — inertia tensor + principal moments (mass-property family)
- repair_drop_duplicate_facets — cull doubled surface patches
- non_manifold_edge_examples — illustrative locators for over-shared edges
...
- `fuzz/fuzz_targets/repair.rs` now also drives `mesh_inertia` and
  ...
  panic-freedom fuzzer alongside every other diagnostic + repair.
